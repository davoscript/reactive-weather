...
var WeatherFuture = React.createClass({
	...
	render: function() {
		...
		return (
			...
			<table style={tableStyle} className="table table-striped text-center rw-weather-table">
			<thead>
			<tr>
			<th className="col-md-3 text-center rw-day">Day</th>
			<th className="col-md-3 text-center rw-temperature">Temperature</th>
			<th className="col-md-3 text-center rw-description">Description</th>
			</tr>
			</thead>
			<tbody>
			{weatherFutureItem}
